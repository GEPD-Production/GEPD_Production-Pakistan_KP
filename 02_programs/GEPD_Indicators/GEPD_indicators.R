...
indicators <- list(
  ...
  c("SE.PRM.SSUP.11 ", " principal_offered		", "school", "SSUP", "All"), # (De Facto) Average number of trainings that principals report having been offered to them in the past year
