---
title: "Global Education Policy Dashboard - Pakistan - KP 2023"
format: 
  pptx:
    fig_height: 8
    fig_width: 10
...
learning_dataMean <- summarise(group_by(learning_data_plot, Gender , Type), MD = round(wtd.mean(math_student_knowledge, g4_comb_weight, na.rm=TRUE),1))

  ggplot(learning_data_plot, aes(x=Type, y=math_student_knowledge, fill=Gender)) + #now plot the output in a bar graph
    geom_violin(aes(weight=g4_comb_weight), position="dodge") +
     geom_text(data = learning_dataMean, aes(x=Type, y=MD, label=MD), 
               position = position_dodge(width = 0.9), size = 5, vjust = -1) +
     geom_point(data = learning_dataMean, aes(x=Type, y=MD),
                position = position_dodge(width = 0.9)) +
  ggtitle("Distribution of 4th Grade Math Student Assessment Scores by Gender and Urban/Rural") +
  xlab(str_wrap("Urban/Rural Status", width=75))+
  ylab(str_wrap("Percentage Correcton on 4th Grade Assessment",35)) +
  scale_fill_discrete(name="Gender", 
                      labels=c('All Students','Girls','Boys' )) +
...
learning_dataMean <- summarise(group_by(learning_data_plot, Gender , Type), MD = round(wtd.mean(literacy_student_knowledge, g4_comb_weight, na.rm=TRUE),1))

  ggplot(learning_data_plot, aes(x=Type, y=literacy_student_knowledge, fill=Gender)) + #now plot the output in a bar graph
    geom_violin(aes(weight=g4_comb_weight), position="dodge") +
     geom_text(data = learning_dataMean, aes(x=Type, y=MD, label=MD), 
               position = position_dodge(width = 0.9), size = 5, vjust = -1) +
     geom_point(data = learning_dataMean, aes(x=Type, y=MD),
                position = position_dodge(width = 0.9)) +
  ggtitle("Distribution of 4th Grade Literacy Student Assessment Scores by Gender and Urban/Rural") +
  xlab(str_wrap("Urban/Rural Status", width=75))+
  ylab(str_wrap("Percentage Correcton on 4th Grade Assessment",35)) +
  scale_fill_discrete(name="Gender", 
                      labels=c('All Students','Girls','Boys' )) +
