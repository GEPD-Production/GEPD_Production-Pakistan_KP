...
foreach var of local drop{
	...
	label var strata_code "Strata (urban/rural/boys/girls/coedu)"
...
recode m1saq7 (0/85=1 "85 or less") (86/100=2 "86-100 inclu") ///
...
recode m1saq8a_etri (0/10=1 "10 and less") ///
(11/30=2 "11-30 inclu") (31/50=3 "31-50 inclu") ///
(51/70=4 "51-70 inclu") (71/90=5 "71-90 inclu") ///
(91/max=6 "More than 90")(.=.), gen (m1saq8a_etri_c)
...
recode m7saq8_y (0/2=2 "2 years and less") (11/15=11 "11 to 15 years") (16/max=16 "more than 15 years")(.=.), gen (m7saq8_c)
...
recode m7saq9 (0/35=35 " 35 years old and less")(58/max=58 "more than 57 years")(.=.), gen (m7saq9_c)
	tab m7saq9_c, m
...
recode m7shq2_satt (0/40000=40000 "40000 and less") (95000.01/max=96000 "more than 95000")(.=.), gen (m7shq2_satt_c)
	tab m7shq2_satt_c, m
...
principal_training_temp school_teacher_ques_INPT principal_eval_tot principal_knowledge_avg
...
*Checking IDs:
tab teachers_id, m				//Typically all teachers should have an ID (4 missing teachers ID)
tab school_code, m				//Typically all schools should have an ID
...
recode m3saq6 (0/28=28 " 28 years old and less")(52/max=52 "more than 51 years")(.=.), gen (m3saq6_c)
	tab m3saq6_c, m
...
recode m3seq7_tatt (8/max=8 "from 8 to 12 months")(.=.), gen (m3seq7_tatt_c)
...
recode m3saq5_y (32/max=32 "more than 31 years")(.=.), gen (m3saq5_c)
...
uc_name village_city_name vill_neighbour_council_name pk_no na_no building_owner_ship location location head_master_name ///
district_2 emis_code xcoordinate ycoordinate total_enrollment school_headmaster_contact_no ///
...
loc drop school_code school_name_preload m6s1q1 interview__id interview__key school district tehsil shift schoollevel strata location g4_student_weight_temp
foreach var of local drop{
      capture drop `var'
      di in r "return code for: `var': " _rc
}
...
log on dropped_vars								
*Dropping un necessary varibales 
loc drop school_code school_name_preload _merge m8s1q1 interview__id interview__key school interview__id interview__key school district tehsil shift schoollevel strata location g4_student_weight_temp
foreach var of local drop{
      capture drop `var'
      di in r "return code for: `var': " _rc
}
