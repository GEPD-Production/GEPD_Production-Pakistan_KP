...
# In the PAK ICT and PAK KP folders, names of datasets start with PAK_...
# Create a separate script for pakistan files

countries=["PAK_ICT", "PAK_KP"]
for country in countries:
    ...
    teacher_roster = pd.read_stata(save_input_folder + country + "/" + "PAK_teacher_absence.dta")
    ...
    #teacher pegaogy
    teacher_pedagogy = pd.read_stata(save_input_folder + country + "/" + "PAK_teacher_pedagogy.dta")
    ...
    teacher_content = pd.read_stata(save_input_folder + country + "/" + "PAK_teacher_assessment.dta")
    ...
    teacher_questionaire = pd.read_stata(save_input_folder + country + "/" + "PAK_teacher_questionnaire.dta")
