...
fre m1s0q2_name
fre m1s0q2_name_incorrect


clonevar tier_govt_ar = m1s0q2_name
replace tier_govt_ar = 1 if  info_correct == 0 & m1s0q2_name_incorrect ==1
replace tier_govt_ar = 3  if info_correct == 0 & m1s0q2_name_incorrect ==2
